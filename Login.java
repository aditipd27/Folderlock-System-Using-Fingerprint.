...
public class Login extends JFrame implements ActionListener,Runnable
{
    ...
    static String Location="C:\\Users\\Diamond\\Documents\\FolderLockSystem\\image\\";
	...
	try
		...
		l2 = new JLabel ("Aditi Pawar");
		l2.setForeground (Color.black);
		l2.setBounds (340, 80, 190, 25);

		l3 = new JLabel ("Rani Pawar");
		l3.setForeground (Color.black);
		l3.setBounds (340, 100, 190, 25);

		l4 = new JLabel ("Vaishnavi Jadhav");
